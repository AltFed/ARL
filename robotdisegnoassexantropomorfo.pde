...
void initRe(){
// ovvero R06
  Re[0][0]=(cos(alfa)*sin(PI/2-beta)*cos(theta)-sin(alfa)*sin(theta));
  Re[0][1]=(-cos(alfa)*sin(PI/2-beta)*sin(theta)-sin(alfa)*cos(theta));
  Re[0][2]=(cos(alfa)*cos(PI/2-beta));
  Re[1][0]=(sin(alfa)*sin(PI/2-beta)*cos(theta)+cos(alfa)*sin(theta));
  Re[1][1]=(-sin(alfa)*sin(PI/2-beta)*sin(theta)+cos(alfa)*cos(theta));
  Re[1][2]=(sin(alfa)*cos(PI/2-beta));
  Re[2][0]=(-cos(theta)*cos(PI/2-beta));
  Re[2][1]=(cos(PI/2-beta)*sin(theta));
  Re[2][2]=(sin(PI/2-beta));
